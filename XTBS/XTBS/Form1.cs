...
namespace XTBS
{
    public partial class Form1 : Form
    {
        ...
        private void btncszd_Click(object sender, EventArgs e)
        {

        }

        private void btnbs_MouseClick(object sender, MouseEventArgs e)
        {
        ...
        private void 一般最小二乘法ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var frm = new FormPlus1();
            frm.ShowDialog();
        }

        private void 继电反馈辨识ToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            var frm = new Form4();
            frm.ShowDialog();
        }
        ...
        private void btnxnpg_Click(object sender, EventArgs e)
        {
            var frm = new Form3();
            frm.ShowDialog();
        }
